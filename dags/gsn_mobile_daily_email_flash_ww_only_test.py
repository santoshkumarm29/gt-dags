...
dag = DAG(
    dag_id='etl_gsn_daily_kpi_email_flash_ww_only_test_000',
...
t_preview_send_email = PythonOperator(
    ...
    op_kwargs={'vertica_conn_id': 'vertica_conn',
               ...
               'subject': 'TEST: WW ONLY. PREVIEW: Flash Daily KPIs: {rev} ({delta_rev}) IAP Rev | {dau} ({delta_dau}) DAU | {installs} ({delta_installs}) Installs',
