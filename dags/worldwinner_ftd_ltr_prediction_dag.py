...
from worldwinner_ftd_ltr_prediction.worldwinner_ftd_ltr_feature_getter import get_features_df
from worldwinner_ftd_ltr_prediction.worldwinner_ftd_ltr_email import send_report_email
...
prediction_table_name = 'ww.ltr_ftd_predictions_historical'
features_s3_bucket_name = Variable.get("general_s3_bucket_name")
features_file_template = "s3://{{ features_s3_bucket_name }}/features/ltr/worldwinner_ftd_ltr_predictions/v{{ model_version }}/features_{{ params.n_days_observation }}_{{ params.n_days_horizon }}_{{ ds }}.csv"
...
dag = DAG(
    dag_id='worldwinner_ftd_ltr_prediction_v{model_version}.{dag_version}'.format(model_version=MODEL_VERSION,
...
model_s3_filepaths_complete = [model_path_base + x for x in [
    'ltr/worldwinner_ftd/v1/worldwinner_ftd_ltr_model_v1_1_45_2019-05-01.pkl',
    'ltr/worldwinner_ftd/v1/worldwinner_ftd_ltr_model_v1_2_45_2019-05-01.pkl',
    'ltr/worldwinner_ftd/v1/worldwinner_ftd_ltr_model_v1_3_45_2019-05-01.pkl',
    'ltr/worldwinner_ftd/v1/worldwinner_ftd_ltr_model_v1_4_45_2019-05-01.pkl',
    'ltr/worldwinner_ftd/v1/worldwinner_ftd_ltr_model_v1_5_45_2019-05-01.pkl',
    'ltr/worldwinner_ftd/v1/worldwinner_ftd_ltr_model_v1_6_45_2019-05-01.pkl',
    'ltr/worldwinner_ftd/v1/worldwinner_ftd_ltr_model_v1_7_45_2019-05-01.pkl',
    'ltr/worldwinner_ftd/v1/worldwinner_ftd_ltr_model_v1_10_45_2019-05-01.pkl',
    'ltr/worldwinner_ftd/v1/worldwinner_ftd_ltr_model_v1_14_45_2019-05-01.pkl'
]]
...
t_final_send_email = PythonOperator(
    ...
    op_kwargs={
        ...
        'subject': 'ZEUS: WorldWinner LTR - First Time Deposit Based - {ds}',
        'model_version': MODEL_VERSION,
