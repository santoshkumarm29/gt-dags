...
from worldwinner_ftd_ltr_prediction.worldwinner_ftd_ltr_features_v1 import get_features_df as _get_features_df
...
def get_features_df(ds, conn, model_s3_filepaths):
    ...
    assert app_name == 'worldwinner_ftd', 'Expected app_name "worldwinner_ftd", instead got "{}"'.format(app_name)
