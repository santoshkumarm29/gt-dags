...
#from kochava_importer_test.kochava_importer_config import get_config as master_config
from kochava_importer_test.kochava_importer_config import get_config as master_config #by skm

#from kochava_importer_test.install_importer_parser import default_columns, nested_columns, vendor_specific_columns
from kochava_importer_test.install_importer_parser import default_columns, nested_columns, vendor_specific_columns #by skm

#from kochava_importer_test.kochava_importer_driver import request_report, \
#    truncate_staging_table, wait_on_report, download_report, parse_install_data
from kochava_importer_test.kochava_importer_driver import request_report, \
    truncate_staging_table, wait_on_report, download_report, parse_install_data #by skm   
#from airflow.operators import BaseOperator #by skm
from airflow.models import BaseOperator
#from airflow.hooks import BaseHook #by skm
...
class KochavaImporter(BaseOperator):
    ...
    def get_range(self, next_execution_date):
        ...
        start_date = next_execution_date_pst - timedelta(40)
